...
class ShippingControllerDoneTest {
    ...
    void getDone_success() throws Exception {
        // given
        var list = List.of(
                new ShippingNoteSummaryResponse(2001L, "ACME", 3, 50, "COMPLETED", "2025-10-20T08:30:00Z", "2025-10-20T10:00:00Z"),
                new ShippingNoteSummaryResponse(2002L, "BETA", 1, 10, "DELAYED", "2025-10-21T11:00:00Z", null)
        );
