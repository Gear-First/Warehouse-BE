...
class ShippingControllerDoneTest {
    ...
    void getDone_success() throws Exception {
        // given
        var list = List.of(
                new ShippingNoteSummaryResponse(2001L, null, "ACME", 3, 50, "COMPLETED", null, null, "2025-10-20T10:00:00Z"),
                new ShippingNoteSummaryResponse(2002L, null, "BETA", 1, 10, "DELAYED", null, null, "2025-10-21T11:00:00Z")
        );
