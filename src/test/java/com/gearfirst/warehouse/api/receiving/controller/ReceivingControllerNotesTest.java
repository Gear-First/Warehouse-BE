...
class ReceivingControllerNotesTest {
    ...
    void getNotes_notDone_success() throws Exception {
        var list = List.of(
                new ReceivingNoteSummaryResponse(101L, "ABC Supply", 3, 120, "PENDING", "WH1", "2025-10-20T09:00:00Z", null),
                new ReceivingNoteSummaryResponse(102L, "BCD Parts", 2, 45, "IN_PROGRESS", "WH1", "2025-10-20T09:05:00Z", null)
        );
    ...
    void getNotes_done_success() throws Exception {
        var list = List.of(
                new ReceivingNoteSummaryResponse(201L, "ABC Supply", 1, 10, "COMPLETED_OK", "WH1", "2025-10-20T08:00:00Z", "2025-10-20T10:00:00Z"),
                new ReceivingNoteSummaryResponse(202L, "ABC Supply", 1, 10, "COMPLETED_ISSUE", "WH1", "2025-10-20T09:00:00Z", "2025-10-20T15:00:00Z")
        );
